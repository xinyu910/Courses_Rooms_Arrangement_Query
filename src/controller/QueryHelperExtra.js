...
class QueryHelperExtra {
    ...
    ValidationApplyTokenValue(value) {
    ...
    ValidationColumnValueWithGroup(value) {
        if (!(Array.isArray(value))) {
            return 0;
        }
        else if (value.length < 1) {
...
exports.default = QueryHelperExtra;
//# sourceMappingURL=QueryHelperExtra.js.map