import QueryHelperExtra from "./QueryHelperExtra";
export default class QueryHelper extends QueryHelperExtra {
    constructor() {
        super();
    }

    public queryValidation(query: any): number {
    ...
    private ValidationTransformation(value: any): number {
    ...
    private ValidationColumn(value: any): number {
        if (value == null || typeof value !== "object") {
            return 0;
        }
    ...
    private ValidationColumnWithGroup(value: any): number {
        if (value == null || typeof value !== "object") {
            return 0;
        }
        const OptionKeys = Object.keys(value);
